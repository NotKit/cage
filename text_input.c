...
static struct cg_text_input *relay_get_focusable_text_input(
...
static struct cg_text_input *relay_get_focused_text_input(
		struct cg_input_method_relay *relay) {
	struct cg_text_input *text_input = NULL;
	wl_list_for_each(text_input, &relay->text_inputs, link) {
...
static void text_input_set_pending_focused_surface(
		struct cg_text_input *text_input, struct wlr_surface *surface) {
...
static void relay_send_im_state(struct cg_input_method_relay *relay,
...
struct cg_text_input *cg_text_input_create(
		struct cg_input_method_relay *relay,
		struct wlr_text_input_v3 *text_input) {
...
static void relay_handle_text_input(struct wl_listener *listener,
	...
	struct cg_text_input *text_input = cg_text_input_create(relay,
		wlr_text_input);
	if (!text_input) {
		return;
	}
